declare module 'tauri-plugin-android-fs-api' {
    ...
    type AndroidUriPermissionState =
        | 'Read'
        | 'Write'
        | 'ReadAndWrite'
        | 'ReadOrWrite'
    ...
    export class AndroidFs {
        ...
        static checkPickerUriPermission(
            uri: AndroidFsUri,
            state: AndroidUriPermissionState
        ): Promise<boolean>
        static persistPickerUriPermission(uri: AndroidFsUri): Promise<void>
        static checkPersistedPickerUriPermission(
            uri: AndroidFsUri,
            state: AndroidUriPermissionState
        ): Promise<boolean>
        static releasePersistedPickerUriPermission(
            uri: AndroidFsUri
        ): Promise<boolean>
